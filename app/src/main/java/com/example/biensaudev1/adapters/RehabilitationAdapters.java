...
public class RehabilitationAdapters extends RecyclerView.Adapter<RehabilitationAdapters.ViewHolder>{

    private Context context;
    private List<RehabilitationModel> rehabilitationModelList;

    public RehabilitationAdapters(Context context, List<RehabilitationModel> rehabilitationModelList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.rehabilitation_itens,parent,false));
    }
